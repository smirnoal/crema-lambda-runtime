...
This FAQ is informational only. The binding terms are in `LICENSE` (ELv2).
...
Yes. See `COMMERCIAL-LICENSE.md` for the commercial licensing path.

## Is this OSI open source?

No. ELv2 is source-available, not an OSI-approved open-source license.
