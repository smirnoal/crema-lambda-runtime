...
# docker run -it --rm -p8080:8080
#   -v /Users/asmirnov/workspace/smirnoal-ric/smirnoal-ric/bootstrap/target/test-classes:/var/task \
#   public.ecr.aws/lambda/java:17 \
#   com.smirnoal.lambda.handlers.Echo
