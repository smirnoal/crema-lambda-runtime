...
fn throw_rapid(env: &mut JNIEnv, msg: &str) {
    let _ = env.throw_new(
        "com/smirnoal/lambda/rapid/client/LambdaRapidClientException",
        msg,
    );
}
...
fn marshal_invocation_request(
    ...
    let result = env.new_object(
        "com/smirnoal/lambda/rapid/client/dto/InvocationRequest",
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeCreate(
    mut env: JNIEnv,
    _class: JClass,
    host: JString,
) -> jlong {
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeDestroy(
    _env: JNIEnv,
    _class: JClass,
    handle: jlong,
) {
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeNext(
    mut env: JNIEnv,
    _this: JObject,
    handle: jlong,
) -> jobject {
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeReportInvocationSuccess(
    mut env: JNIEnv,
    _this: JObject,
    handle: jlong,
    request_id: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeStreamingStart(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
    request_id: JString,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeStreamingSetContentType(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeStreamingWrite(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
    session_handle: jlong,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeStreamingComplete(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
    session_handle: jlong,
...
#[no_mangle]
pub unsafe extern "system" fn Java_com_smirnoal_lambda_rapid_client_HyperLambdaRapidHttpClient_nativeStreamingFail(
    mut env: JNIEnv,
    _class: JClass,
    handle: jlong,
    session_handle: jlong,
